...
const imagePathPrefix = "/images/notepad/";
const imageUrls = [
  { title: "", image: `${imagePathPrefix}notepad.png` },
  { title: "", image: `${imagePathPrefix}notepad-diet.png` },
  { title: "", image: `${imagePathPrefix}notepad-baking.png` },
...
const productInfo = {
  title: "Notepad",
  description: `A true classic, notepads are simple, effective, and an everyday essential. Make sure you're on top of your plans, every ingredient is in your shopping cart, and that your ideas are never forgotten.`,
};
...
const descriptionList = {
  ...
  list: [
    `Planning errands`,
    "Shopping lists",
    "Finding out if your classmate likes you",
  ],
};
