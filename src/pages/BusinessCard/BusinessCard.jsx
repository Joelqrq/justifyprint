...
const imagePathPrefix = "/images/business-card/";
const imageUrls = [
...
const descriptionList = {
  ...
  list: [
    ...
    "Available in Original, Cotton, Super paper stocks",
    "Matte, Gloss, Soft Touch paper finishes",
    "Color Edge, Spot UV, Emboss/Deboss, Hot Stamping and more special finishes",
  ],
};
