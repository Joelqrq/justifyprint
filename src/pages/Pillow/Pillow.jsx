...
const imagePathPrefix = "/images/pillow/";
const imageUrls = [
  { title: "", image: `${imagePathPrefix}pillow.png` },
  { title: "", image: `${imagePathPrefix}pillow-business.png` },
  { title: "", image: `${imagePathPrefix}pillow-hotel.png` },
  { title: "", image: `${imagePathPrefix}pillow-quote.png` },
...
const productInfo = {
  title: "Pillow",
  description: `The one thing people always see before bed, and the first thing they see when they wake up, pillows are an important constant in everyday life and now you can design your own.`,
};
