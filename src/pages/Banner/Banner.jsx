...
const imagePathPrefix = "/images/banner/";
const imageUrls = [
  { title: "", image: `${imagePathPrefix}banner.png` },
  { title: "", image: `${imagePathPrefix}banner-wedding.png` },
...
const productInfo = {
  title: "Banner",
  description: `They say advertising is a dialog with the people, so why not get the conversation started with a banner ad designed to get people talking? When in doubt, make it big.`,
};
