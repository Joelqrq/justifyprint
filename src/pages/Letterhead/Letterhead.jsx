...
const imagePathPrefix = "/images/letterhead/";
const imageUrls = [
  { title: "", image: `${imagePathPrefix}letterhead.png` },
  { title: "", image: `${imagePathPrefix}letterhead-corporate.png` },
  { title: "", image: `${imagePathPrefix}letterhead-wedding.png` },
  { title: "", image: `${imagePathPrefix}letterhead-music.png` },
  { title: "", image: `${imagePathPrefix}letterhead-certificate.png` },
...
const productInfo = {
  title: "Letterhead",
  description: `Custom stationery with your symbol or logo on it gives an air of luxury, influence, and power, and is one of the easiest ways to elevate any document you send out.`,
};
...
const descriptionList = {
  ...
  list: [
    ...
    "Hotel room stationery",
    "Fancy, official documents",
  ],
};
