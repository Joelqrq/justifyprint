...
const imagePathPrefix = "/images/canvas-tote-bag/";
const imageUrls = [
  { title: "", image: `${imagePathPrefix}canvas-tote-bag.png` },
  { title: "", image: `${imagePathPrefix}canvas-tote-bag-1.png` },
  { title: "", image: `${imagePathPrefix}canvas-tote-bag-2.png` },
  { title: "", image: `${imagePathPrefix}canvas-tote-bag-3.png` },
  { title: "", image: `${imagePathPrefix}canvas-tote-bag-4.png` },
...
const productInfo = {
  ...
  description: `In a world where single-use plastics are still prevalent, these tote bags are perfect for the eco-conscious consumer of today who care about their impact on the Earth.`,
};
