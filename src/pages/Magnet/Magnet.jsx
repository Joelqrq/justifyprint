...
const imagePathPrefix = "/images/magnet/";
const imageUrls = [
  { title: "", image: `${imagePathPrefix}magnet.png` },
...
const productInfo = {
  title: "Magnet",
  description: `Did you know that more likely than not, the people you know have magnets on their fridge? And more likely than not, they're going to be there for a very long time. Great opportunity, we think.`,
};
