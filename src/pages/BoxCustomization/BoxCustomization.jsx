  ...
  return (
    <div className="pt-12 flex flex-col items-center">
      <div className="p-6 flex flex-col items-center">
        ...
        <img className="mt-6 min-w-[300px] min-h-[150px] md:h-[400px] object-contain object-top" src={mainImage} />
      </div>
      <div className="flex flex-col items-center divide-y divide-solid divide-zinc-200 dark:divide-zinc-700">
        <div className="py-6 flex flex-col items-center">
          ...
          <div className="flex flex-col md:flex-row m-8">
            <div>
              <img className="h-[16rem] lg:h-[24rem] object-contain object-top" src={boxSizeImage} />
            </div>
        ...
        <div className="py-6 flex flex-col items-center">
          ...
          <div className="flex flex-col md:flex-row m-6">
            ...
            <div>
              <img className="h-[16rem] lg:h-[24rem] object-contain object-top" src={boxColorImage} />
            </div>
          </div>
        </div>
        <div className="py-6 flex flex-col items-center">
          ...
          <div className="flex flex-col md:flex-row m-6">
            <div>
              <img className="h-[16rem] lg:h-[24rem] object-contain object-top" src={customLogoImage} />
            </div>
            <div className="mt-6 md:ml-9 w-[28ch] md:w-[48ch] lg:w-[64ch]">
              <p className="break-words text-sm lg:text-base text-center tracking-wide text-zinc-800 dark:text-zinc-200">
        ...
        <div className="py-6 flex flex-col items-center">
          ...
          <div className="flex flex-col md:flex-row m-6">
            ...
            <div>
              <img className="h-[16rem] lg:h-[24rem] object-contain object-top" src={customInsertImage} />
            </div>
          </div>
        </div>
        <div className="py-6 flex flex-col items-center">
          ...
          <div className="flex flex-col md:flex-row m-6">
            <div>
              <img className="h-[16rem] lg:h-[24rem] object-contain object-top" src={customSleeveImage} />
            </div>
            <div className="mt-6 md:ml-9 w-[28ch] md:w-[48ch] lg:w-[64ch]">
              <p className="break-words text-sm lg:text-base text-center tracking-wide text-zinc-800 dark:text-zinc-200">
        ...
        <div className="py-6 flex flex-col items-center">
          ...
          <div className="flex flex-col md:flex-row m-6">
            ...
            <div>
              <img className="h-[16rem] lg:h-[24rem] object-contain object-top" src={paperFillersImage} />
            </div>
          </div>
        </div>
        <div className="py-6 flex flex-col items-center">
          ...
          <div className="flex flex-col md:flex-row m-6">
            <div>
              <img className="h-[16rem] lg:h-[24rem] object-contain object-top" src={mailingCartonImage} />
            </div>
            <div className="mt-6 md:ml-9 w-[28ch] md:w-[48ch] lg:w-[64ch]">
              <p className="break-words text-sm lg:text-base text-center tracking-wide text-zinc-800 dark:text-zinc-200">
        ...
        <div className="py-6 flex flex-col items-center">
          ...
          <div className="flex flex-col md:flex-row m-6">
            ...
            <div>
              <img className="h-[16rem] lg:h-[24rem] object-contain object-top" src={paperGiftBagsImage} />
            </div>
          </div>
        </div>
      </div>
