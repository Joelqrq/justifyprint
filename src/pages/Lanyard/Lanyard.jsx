...
const imagePathPrefix = "/images/lanyard/";
const imageUrls = [
  { title: "", image: `${imagePathPrefix}lanyard.png` },
...
const productInfo = {
  title: "Lanyard",
  description: `When it comes to workplace, social events or even public affairs, nothing comes more in handy than Lanyard. It is usable for every occasions, suitable for marketing and most importantly looks professional while maintaining a stylish and professional look.`,
};
