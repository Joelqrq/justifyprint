...
const imagePathPrefix = "/images/roll-up-stand/";
const imageUrls = [
  { title: "", image: `${imagePathPrefix}roll-up-stand.png` },
  { title: "", image: `${imagePathPrefix}roll-up-stand-cafe.png` },
  { title: "", image: `${imagePathPrefix}roll-up-stand-exhibition.png` },
  { title: "", image: `${imagePathPrefix}roll-up-stand-hotel.png` },
...
const productInfo = {
  title: "Roll Up Stand",
  description: `Stand up to the competition with an ad that stands on its own! Roll-up stands are a portable, and super easy to set up just about anywhere you want, whenever you want.`,
};
