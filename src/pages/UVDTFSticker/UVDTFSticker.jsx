...
const imagePathPrefix = "/images/uv-dtf-sticker/";
const imageUrls = [
  { title: "", image: `${imagePathPrefix}uv-dtf-sticker.png` },
...
const productInfo = {
  ...
  description: `UV DTF Sticker is a fun and easy way to create color-rich designs on film and transfer them onto almost any surface.`,
};

const descriptionList = {
  title: "Customize product to all your needs.",
  list: [
    `Decorating Bullet Journal`,
    "Decorating Personal Accessories",
    "Customized Corporate Gift",
  ],
};

export const UVDTFSticker = () => {
