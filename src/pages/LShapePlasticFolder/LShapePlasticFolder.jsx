...
const imagePathPrefix = "/images/l-shape-plastic-folder/";
const imageUrls = [
  { title: "", image: `${imagePathPrefix}l-shape-plastic-folder.png` },
  { title: "", image: `${imagePathPrefix}l-shape-plastic-folder-bank.png` },
  { title: "", image: `${imagePathPrefix}l-shape-plastic-folder-insurance.png` },
  { title: "", image: `${imagePathPrefix}l-shape-plastic-folder-travel.png` },
  { title: "", image: `${imagePathPrefix}l-shape-plastic-folder-tuition.png` },
  { title: "", image: `${imagePathPrefix}l-shape-plastic-folder-law.png` },
...
const productInfo = {
  ...
  description: `This is your first line of defense for any important papers you might want to keep safe. A custom folder is the only option for anyone looking to say they're always prepared.`,
};
...
export const LShapePlasticFolder = () => {
