...
const imagePathPrefix = "/images/hard-cover-menu/";
const imageUrls = [
  { title: "", image: `${imagePathPrefix}hard-cover-menu.png` },
...
const productInfo = {
  ...
  description: `One of the most important pieces in any F&B setting, being able to choose your meal from inside a hard cover menu filled with beautiful food choices is a top-tier, elevated experience.`,
};
