...
const imagePathPrefix = "/images/packaging-box/";
const imageUrls = [
  { title: "", image: `${imagePathPrefix}packaging-box.png` },
  { title: "", image: `${imagePathPrefix}packaging-box-1.png` },
  { title: "", image: `${imagePathPrefix}packaging-box-2.png` },
  { title: "", image: `${imagePathPrefix}packaging-box-3.png` },
  { title: "", image: `${imagePathPrefix}packaging-box-4.png` },
  { title: "", image: `${imagePathPrefix}packaging-box-5.png` },
  { title: "", image: `${imagePathPrefix}packaging-box-6.png` },
  { title: "", image: `${imagePathPrefix}packaging-box-7.png` },
...
const productInfo = {
  title: "Packaging Box",
  description: `Printed packaging boxes are an essential part of any product’s branding and marketing. They not only protect the product but also provide an eye-catching display that can attract customers. Learn more about the benefits of printed packaging boxes for your business.`,
};
