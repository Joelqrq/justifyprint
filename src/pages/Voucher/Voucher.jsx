...
const imagePathPrefix = "/images/voucher/";
const imageUrls = [
  { title: "", image: `${imagePathPrefix}voucher.png` },
  { title: "", image: `${imagePathPrefix}voucher-music.png` },
  { title: "", image: `${imagePathPrefix}voucher-gift.png` },
  { title: "", image: `${imagePathPrefix}voucher-wedding.png` },
...
const productInfo = {
  title: "Voucher",
  description: `Everyone loves a good deal, so you know vouchers are a great way to get your business out there. Bonus: Printing with Excard also gets you a good deal!`,
};
