...
const imagePathPrefix = "/images/stamp-chop/";
const imageUrls = [
  { title: "", image: `${imagePathPrefix}stamp-chop.png` },
  { title: "", image: `${imagePathPrefix}stamp-chop-kp.png` },
  { title: "", image: `${imagePathPrefix}stamp-chop-hm.png` },
...
const productInfo = {
  title: "Stamp Chop",
  description: `No one likes filling out the same information over and over again, so why not make a stamp that does that for you? Get a custom stamp chop and make your life a little easier.`,
};
